...
- This project is using the pro edition of Flux UI. It has full access to all components.
...
### Documentation
Always look up documentation through context-7 MCP before implementing anything. This takes priority over other documentation sources.
